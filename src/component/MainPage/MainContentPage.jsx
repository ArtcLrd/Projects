...
import { Container, Row, Col, Button, Form, ToggleButton, ListGroup, Dropdown, Accordion, Badge,Card,Modal, Toast, ToastContainer } from "react-bootstrap";
      ...
      <Form className="p-0 m-0 start-0">
        <Form.Group>
         ...
         <div className="d-flex justify-content-between mt-2 end-0 py-2 m-0"  style={{
          ...
          <div className="d-flex justify-content-between gap-3 py-0 mx-2 start-0" style={{
            position: "relative"
          }}>
...
function MainContentPage(){
          ...
          <Container>
            ...
            <ListGroup>
            {
              filteredTasks.length == 0 ?(
                 <ListGroup.Item className="text-center text-muted" style={{height:"300px",maxHeight: 'calc(100vh - 250px)', overflowY: 'auto'}}>
          No tasks to display
        </ListGroup.Item>
              ) : (
 ...
 <div className="d-flex align-items-center">
  ...
  <Button 
        ...
        className={' p-0 m-0 sidebar bg-tertiary min-vh-100 position-fixed top-0 end-0 transition-all duration-300 z-index-1 align-items-center text-white'}
        ...
        >
          {selectedTask ? (
            <div className="p-1 w-100 bg-light"
              style={{height:"100vh"}}>
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h4 className="mb-0 text-dark" style={{position:"absolute", top:"10%", left:"35%"}}>Task Details</h4>
                <Button 
                  variant="link" 
              ...
              <Card className="mb-3 p-3 " style={{position:"absolute", top:"20%", width:"100%", overflow:"hidden"}}>
                <Card.Body>
                  ...
                  <div className="mb-2">
                    ...
                    <Form.Check 
                      ...
                      checked={selectedTask.completed ? true : false}
